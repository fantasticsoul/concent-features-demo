...
function FnCounter(){
  ...
  return (
    <div>
      module state:{ctx.state.count}<br/>
...
export default function App() {
  return (
    <div className="App">
      <h3>class component and fn component share the module state, 
        and hold their own private state at the same time</h3>
      <Counter />
      <FnCounter />
    </div>
  );
